...
<nav class="navbar  navbar-expand-lg  navbar-light  bg-light">
  ...
  <form name="reF" id="reF" action="editR" method="POST"
    ...
    <div class="ResumePanel">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <input type="text" id="pname" name="pname" class="form-control" style="height: 32px; width: 300px; margin-bottom:0.5em;" value="${res.pname}" readonly="readonly"/>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        <label for="pbirth"  style="width:78px;"> <b> 생년월일 : </b> </label>
                                            <input type="text" id="pbirth" name="pbirth" class="form-control" style="height: 32px; width: 300px; margin-bottom:0.5em;" value="${res.pbirth}" readonly="readonly"/>
                                    </td>
                                </tr>
            ...
            <div id="intro">
                ...
                <textarea class="form-control" id="pmsg" name="pmsg" placeholder="자기소개를 작성하세요" style="height:200px"> ${res.pmsg} </textarea>
        ...
        <input type="hidden" value="${res.idx}" id="idx" name="idx" >
  		</form>
