  ...
  <form name="reF" id="reF" action="resumeAdd" method="POST"
    ...
    <div class="ResumePanel">
            ...
            <div class="row1">
                <div class="form-inline">
                    ...
                    <div id="photo">
                        ...
                        <table>
                            <tr>
                                <td>
                                	<label>증명사진</label>
                                    <input type="file" name="pimagename" id="pimage">
                                </td>
                            </tr>
                    ...
                    <div id="info">
                            ...
                            <tr>
                                <td>
                                    <label for="pname" style="width:100px;"> <b> 이력서 제목: </b></label>
                                    <input type="text" id="ptitle" name="ptitle" class="form-control" style="height: 32px; width: 300px; margin-bottom:0.5em;"/>
                                </td>
                            </tr>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <input type="text" id="pname" name="pname" class="form-control" style="height: 32px; width: 300px; margin-bottom:0.5em;"/>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        <label for="pbirth"  style="width:78px;"> <b> 생년월일 : </b> </label>
                                            <input type="date" id="pbirth" name="pbirth" class="form-control" style="height: 32px; width: 300px; margin-bottom:0.5em;"/>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="form-inline">
                                            <input type="text" id="php1" name="php1" class="form-control"style="height: 32px; width: 90px"/>
                                            <span class=mx-1> <b> - </b> </span>
                                            <input type="text" id="php2" name="php2" class="form-control"style="height: 32px; width: 90px"/>
                                            <span class=mx-1> <b> - </b> </span>
                                            <input type="text" id="php3" name="php3" class="form-control"style="height: 32px; width: 90px; margin-bottom:0.5em;"/>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <input type="text" id="addr" name="addr" class="form-control" style="height: 32px; width: 400px; margin-bottom:0.2em;"/>
            ...
            <div class="row2">
                ...
                <div id="school">
                        ...
                        <div id="Div">
                            ...
                            <select class="select form-control" id="pc" name="pc">                           
                        ...
                        <div id="Div">
                            ...
                            <input type="text" id="pmajor" name="pmajor" class="form-control">
                        </div>
            ...
            <div class="row3">
                ...
                <div id="career">
                        ...
                        <div id="Div">
                            ...
                            <div class="form-inline">
                                <input type="text" id="pdate" name="pdate" class="form-control">
                        ...
                        <div id="Div">
                            ...
                            <input type="text" id="pjname" name="pjname" class="form-control">
                        </div>
                        ...
                        <div id="Div">
                            ...
                            <input type="text" id="pposition" name="pposition"  class="form-control">
                        </div>
            ...
            <div id="intro">
                ...
                <textarea class="form-control" id="pmsg" name="pmsg" placeholder="자기소개를 작성하세요" style="height:200px">  </textarea>
