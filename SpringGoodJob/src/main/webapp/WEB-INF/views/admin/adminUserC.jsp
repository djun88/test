    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
        	...
        	<h3 class="text-center">(기업 회원 관리 페이지)</h3>
        	<%-- ${cartArr} --%> 
            <br>
        	<button type="button" onclick="location.href='userP'">개인 회원 목록</button>&nbsp;
            <button type="button" onclick="location.href='userC'">기업 회원 목록</button>&nbsp;
            <button type="button" onclick="location.href='index'">기업 공고 리스트</button>&nbsp;
            <br><br>
        </div>
      </div>
      ...
      <div class="row">
       ...
       <form name="jobList" id="jobList">
          ...
          <table class="table table-striped">
             ...
             <tbody>
                <!-- -------------------- -->
                <c:forEach var="userc" items="${userCall}" varStatus="state">
                ...
                <tr>
                   ...
                   <td>
                   <button type="button" onclick="resumeEdit('${userc.cid}')">수정</button>
                   <button type="button" onclick="resumeDel('${userc.cid}')">삭제</button>
                   </td>
