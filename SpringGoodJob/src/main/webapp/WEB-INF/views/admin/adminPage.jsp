			...
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="text-center">(기업 공고 관리 페이지)</h3>
						<%-- ${cartArr} --%>
						<br>
						<button type="button" onclick="location.href='userP'">개인
							회원 목록</button>
						&nbsp;
						<button type="button" onclick="location.href='userC'">기업
							회원 목록</button>
						&nbsp;
						<button type="button" onclick="location.href='index'">기업
							공고 리스트</button>
						&nbsp; <br>
						<br>
					</div>
							...
							<table class="table table-striped">
								<thead>
									<tr class="info text-center">
										...
										<th>아이디</th>
										<th>회사명</th>
										<th class="col-md-6">공고제목</th>
										<th class>승인|삭제</th>
									</tr>
								</thead>
								<tbody>
									<!-- -------------------- -->
									<c:forEach var="jvo" items="${joball}" varStatus="state">
										...
										<tr>
											...
											<td>
												<button type="button" onclick="approve('${jvo.cidx}')">승인</button>
												<button type="button" onclick="remove('${jvo.cidx}')">해제</button>
											</td>
