    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
        	...
        	<h3 class="text-center">(개인 회원 관리 페이지)</h3>
        	<%-- ${cartArr} --%> 
            <br>
      ...
      <div class="row">
       ...
       <form name="jobList" id="jobList">
          ...
          <table class="table table-striped">
             ...
             <tbody>
                <!-- -------------------- -->
                <c:forEach var="userp" items="${userPall}" varStatus="state">
                ...
                <tr>
                   ...
                   <td>
                   <button type="button" onclick="resumeEdit('${userp.pid}')">수정</button>
                   <button type="button" onclick="resumeDel('${userp.pid}')">삭제</button>
                   </td>
