...
<c:set var="myctx" value="${pageContext.request.contextPath}"/>			
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
        	<h1 class="text-center">지원자 보기</h1>
        	<h3 class="text-center">(지원자 리스트)</h3>
        	<%-- ${cartArr} --%> 
            <br>
      ...
      <div class="row">
       ...
       <form name="jobList" id="jobList">
          ...
          <table class="table table-striped">
             ...
             <tbody>
                <!-- -------------------- -->
                <c:forEach var="aply" items="${applyList}" varStatus="state">
                ...
                <tr>
                   ...
                   <td>
                   <a href="../resume/resumeview/${aply.idx}" target="_blank">
