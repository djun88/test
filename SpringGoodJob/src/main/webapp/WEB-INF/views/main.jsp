...
<nav class="navbar  navbar-expand-lg  navbar-light  bg-light">
    ...
    <div id="demo" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item active">
                <img src="images/kakao.png" alt="" class="img-responsive">
            </div>

            <div class="carousel-item">
                <img src="images/naver.png" alt="" class="img-responsive">
            </div>

            <div class="carousel-item">
                <img src="images/daum.png" alt="" class="img-responsive">
            </div>

            <div class="carousel-item">
             <img src="images/goodjob.png" alt="" class="img-responsive">
            </div>
   ...
   <!-- <div class= "form-inline"> -->
        ...
        <table class= "tableLeft" id= "fixed">
           <c:forEach var="joba" items="${jobarr}" varStatus="state" begin="0" end="100">
           

            <tr>
				
                <!-- <td> -->	
                		<a href="./job/jobApplyAndLiked/${joba.cidx}" target="_blank">
                        <img src="${pageContext.request.contextPath}/images/${joba.cimage}" alt= "" class="img-fluid" style = "height:250px; width:260px; margin-top:10px; margin-left:10px; margin-bottom: 10px; border: 1px solid black">
                        </a>     
                <!-- </td> -->
