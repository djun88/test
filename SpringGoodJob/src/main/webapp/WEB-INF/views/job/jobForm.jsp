...
<form name="jobP" id="jobP" action="jobPAdd" method="post"
                ...
                <div class="form-inline">
                    ...
                    <div id="photo">
                        ...
                        <table>
                            <tr>
                                <td>
                                    <input type="file" placeholder="" name="cimagename" id="cimage">
                                </td>
                            </tr>
                            ...
                            <table>
								...
								<tr>
                                    <td>
                                        ...
                                        <input type="text" id="cjobt"  name="cjobt" class="form-control" style="height: 32px; width: 300px; margin-bottom:0.5em;"/>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <input type="text" id="cname"  name="cname" class="form-control" style="height: 32px; width: 300px; margin-bottom:0.5em;"/>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <input type="text" id="cdname" name="cdname" class="form-control" style="height: 32px; width: 300px; margin-bottom:0.5em;"/>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="form-inline" style="margin-bottom:0.5em;">
                                            <input type="text" id="chp1" name="chp1" class="form-control"style="height: 32px; width: 90px"/>
                                            <span class=mx-1> <b> - </b> </span>
                                            <input type="text" id="chp2" name="chp2" class="form-control"style="height: 32px; width: 90px"/>
                                            <span class=mx-1> <b> - </b> </span>
                                            <input type="text" id="chp2" name="chp3" class="form-control"style="height: 32px; width: 90px;"/>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <select class="select form-control" id="ccategory" name="ccategory" style="height: 36px; width: 300px;  margin-bottom:0.5em;">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <input type="text" id="caddr" name="caddr" class="form-control" style="height: 32px; width: 400px; margin-bottom:0.2em;"/>
                        ...
                        <table>
                            <tr>
                                <td>
                                    ...
                                    <select class="select form-control" id="cc" name="cc" style= "width: 300px; margin-bottom:0.2em">                           
                                        <option selected> 선택하세요 </option>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <select class="select form-control" id="ce" name="ce" style= "width: 300px; margin-bottom:0.2em">                           
                                        <option selected> 선택하세요 </option>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <select class="select form-control" id="cpr" name="cpr" style= "width: 300px; margin-bottom:0.2em">                           
                                        <option selected> 선택하세요 </option>
                            ...
                            <table>
                                <tr>
                                    <td>
                                        ...
                                        <select class="select form-control" id="ctype" name="ctype" style= "width: 300px; margin-bottom:0.2em">                           
                                            <option selected> 선택하세요 </option>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <input type="text" id="cpay" name="cpay" class="form-control" style="height: 32px; width: 300px; margin-bottom:0.5em;"/>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <select class="select form-control" id="cposition" name="cposition" style= "width: 300px; margin-bottom:0.2em">                           
                                            <option selected> 선택하세요 </option>
