    ...
    <div class="container">
        ...
        <div class="top">
            ...
            <div class="form-inline">
                ...
                <form name="aj" id="aj" action="../../apply/applyPage" method="post">
                           <input type="hidden" name="pid" id="pid"
                              value="${loginUserP.pid}">
                           <input type="hidden" name="cidx" id="cidx" value="${job.cidx}">
                           &nbsp;&nbsp;<button>지원하기</button>&nbsp;&nbsp;
                        </form>
                        <form name="liked" id="liked" action="../../liked/likedAdd" method="post">
                           <input type="hidden" name="pid" id="pid"
                              value="${loginUserP.pid}">
                           <input type="hidden" name="cidx" id="cidx" value="${job.cidx}">
                           <button>찜하기</button>
                ...
                <table>
                    <tr>
                        <td id="tdBelow">
            				...
            				class="img-fluid img-thumbnail"  style="width: 40%;">
                        </td>
                </table>
