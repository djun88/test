...
function go(){
	window.open("idcheckC","idcheck","width=500, height=200, left=200, right=200")
	
}

let check=function(){
	if(UserC.cpw.value != UserC.prepw.value){
...
<body>
	...
	<div class="container">
		...
		<div class="container">
			...
			<div id="suarea">
				<form name="UserC" id="UserC" action="joinC" method="post">
					<table>
						<tr>
							<div id="titleFont">
								<h4>
						...
						<tr>
							<td>
								<div class="form-group">
									...
									</label> <input type="text" name="cnum" id="cnum" class="form-control">
								</div>
								</div>
							</td>
						</tr>
								...
								<div class="form-group">
									...
									<div class="form-inline">
										...
										<input type="text" name="cid" id="cid" placeholder=""
											class="form-control">
										<button type="button" onclick="go()" class="btn btn-primary">아이디 중복 체크</button>
							...
							<td><label for="php1"> <b> 연락처 : </b>
								...
								<div class="form-inline">
									<input type="text" name="chp1" id="chp1" placeholder=""
										class="form-control"> <b> - </b> <input type="text"
										name="chp2" id="chp2" placeholder="" class="form-control">
							...
							<td>
								<div class="form-group">
									...
									<label for="addr"> <b> 주소 </b>
										...
										class="form-control"> <label for="addr2"> <b>
											상세 주소 </b>
							...
							<td align="center">
								<div class="form-group">
									<button type="button" class="btn btn-primary"
										style="height: 50px; width: 160px" onclick="check()">
										<b> 등록하기</b>
									</button>
